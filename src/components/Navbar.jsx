...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-between h-24 px-4 mx-auto max-w-[1240px] text-white'>
            ...
            <div className='block md:hidden' onClick={toggleHandler}>
                {toggle ? <AiOutlineClose size={25} /> : <AiOutlineMenu size={25} />}
            </div>
            <div className={toggle ? 'fixed top-0 left-0 w-[60%] h-full border-r ease duration-500 border-r-green-500' : 'fixed top-[-90%]'}>
